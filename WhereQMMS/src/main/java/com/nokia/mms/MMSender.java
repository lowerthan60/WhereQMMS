...
public class MMSender {
   ...
   */
  public MMResponse send(byte[] buf) throws MMSenderException{


    MMResponse hResponse = send(buf,204);
   ...
   */
  public MMResponse send(byte[] buf, int successcode) throws MMSenderException {
